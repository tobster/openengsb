...
public class MavenTestDomainServiceInstanceFactory implements ServiceInstanceFactory<TestDomain, MavenTestDomainServiceImpl> {
    ...
    @Override
    public MavenTestDomainServiceImpl createServiceInstance(String id, Map<String, String> attributes) {
        MavenTestDomainServiceImpl service = new MavenTestDomainServiceImpl();
